...
describe("API Types — structural validation", () => {
  ...
  it("NeighborhoodsApiResponse shape is correct", () => {
    ...
    const response: NeighborhoodsApiResponse = {
      ...
      neighborhoods: [
        {
          id: 1, cityId: 1, rank: 1, wijknaam: "Centrum", buurtnaam: "Centrum",
          score: 7.5, population: 90000, category: "Hoogste",
          geometry, details: { aantalinwoners: 90000 },
          socialSafetyScore: null, theftSafetyScore: null,
          quietScore: null, greenScore: null,
          accessibilityScore: null, hospitalityScore: null,
          dailyShoppingScore: null, leefbaarometerScore: null,
        },
      ],
    };
  ...
  it("supports null scores and null geometry", () => {
    const response: NeighborhoodsApiResponse = {
      ...
      neighborhoods: [
        {
          id: 1, cityId: 1, rank: 1, wijknaam: "Test", buurtnaam: "Test",
          score: null, population: null, category: null,
          geometry: null, details: null,
          socialSafetyScore: null, theftSafetyScore: null,
          quietScore: null, greenScore: null,
          accessibilityScore: null, hospitalityScore: null,
          dailyShoppingScore: null, leefbaarometerScore: null,
